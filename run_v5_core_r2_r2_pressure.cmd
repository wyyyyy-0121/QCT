...
"%FG_PYTHON%" scripts\run_v5_core_r2_pressure.py ^
  ...
  --output results\v5_core_r2_r2_pressure\historical_100 ^
  --workers 24 ^
  --resume
...
"%FG_PYTHON%" scripts\run_v5_core_r2_pressure.py ^
  ...
  --config research\V5_CORE_R2_R2_CONFIG.json ^
  --output results\v5_core_r2_r2_pressure\enron ^
  --workers 24 ^
  --resume
if errorlevel 1 exit /b %ERRORLEVEL%

"%FG_PYTHON%" scripts\audit_v5_core_r2_pressure.py ^
  --historical-100 results\v5_core_r2_r2_pressure\historical_100\pressure_summary.json ^
  --enron results\v5_core_r2_r2_pressure\enron\pressure_summary.json ^
  --development-audit results\v5_core_r2_r2_retrospective_full\r2_retrospective_audit.json ^
  --output results\v5_core_r2_r2_pressure\pressure_safety_audit.json
exit /b %ERRORLEVEL%
