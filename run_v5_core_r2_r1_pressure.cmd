...
if exist "results\v5_core_r2_r1_pressure\historical_100\pressure_summary.json" (
  rem The historical cohort has a complete, immutable receipt from the prior run.
  rem Do not rerun it merely because the Enron inventory adapter was corrected.
  echo Reusing completed historical-100 pressure receipt.
) else (
