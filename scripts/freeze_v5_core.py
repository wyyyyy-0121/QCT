...
def main() -> None:
    ...
    source_paths = [
        ...
        ROOT / "scripts/build_v5_core_dataset.py",
        ROOT / "scripts/audit_v5_core_dataset.py",
        ROOT / "scripts/audit_v5_core_public_inputs.py",
        ROOT / "scripts/train_v5_core_ranker.py",
        ROOT / "scripts/run_v5_core_stage.py",
        ROOT / "scripts/audit_v5_core_development.py",
        ROOT / "scripts/audit_v5_core_validation.py",
        ROOT / "scripts/run_v5_core_enron.py",
        ROOT / "scripts/run_v5_core_performance.py",
        ROOT / "scripts/build_v5_core_report.py",
        ROOT / "scripts/build_v5_core_results_workbook.mjs",
        ROOT / "scripts/freeze_v5_core.py",
        ROOT / "scripts/prepare_v5_core_third_party_pack.py",
        ROOT / "scripts/lock_v5_core_blind.py",
        ROOT / "scripts/score_v5_core_blind.py",
        ROOT / "research/V5_CORE_METHOD_SPEC.md",
        ROOT / "research/V5_CORE_THIRD_PARTY_PROTOCOL.md",
        ROOT / "research/V5_CORE_IMPLEMENTATION_AUDIT.md",
    ]
    historical_paths = [
