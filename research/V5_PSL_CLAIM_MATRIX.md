...
| Mutation/intervention | Hofer, Wotawa 2013，DOI `10.1109/ISSREW.2013.6688892`，**待全文** | 出版方摘要确认其把 genetic-programming automatic repair 适配到电子表格，并报告找到修复的初步实验 | 标题和摘要不足以判定其变异体、适应度和定位机制；不得把“候选修改/自动修复用于表格调试”写成新方法 | 取得全文后再判断 V5-PSL 的解释性候选探针是否与其适应度或修复搜索重合 |
